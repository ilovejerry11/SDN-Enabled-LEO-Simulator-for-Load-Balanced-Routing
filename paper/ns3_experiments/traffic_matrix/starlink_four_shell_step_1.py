...
GS_NODE_START = 4434  # First ground station node ID (satellites are 0-4236) 
GS_NODE_END = 5434    # Last ground station node ID (exclusive, so 4434-5434)
FLOW_COUNTS = [400, 500, 600]  # Different flow counts to test
...
def create_run_configuration(approach_name, num_flows, list_from_to):
    ...
    local_shell.sed_replace_in_file_plain(
        run_dir + "/config_ns3.properties",
        "[SATELLITE-NETWORK]",
        "starlink_4_shells_isls_plus_grid_ground_stations_298_algorithm_free_one_only_over_isls"
    )
