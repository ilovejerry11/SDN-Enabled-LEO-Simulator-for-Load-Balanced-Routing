...
GS_NODE_START = 1705  # First ground station node ID (satellites are 0-1155) (multishell 1705-2704)
GS_NODE_END = 2705    # Last ground station node ID (exclusive, so 1705-2704)
FLOW_COUNTS = [100, 200, 300]  # Different flow counts to test
...
def create_run_configuration(approach_name, num_flows, list_from_to):
    ...
    local_shell.sed_replace_in_file_plain(
        run_dir + "/config_ns3.properties",
        "[SATELLITE-NETWORK]",
        "kuiper_630_telesat_1015_isls_plus_grid_ground_stations_298_algorithm_free_one_only_over_isls"
    )
